...
petaJawTimur.tambahkanKota("Lawang")
...
petaJawaTimur.tambahkanJalan("Kepanjen","Malang")
petaJawaTimur.tambahkanJalan("Malang","Lawang")
petaJawaTimur.tambahkanJalan("Lawang","Sidoarjo")
petaJawaTimur.tambahkanJalan("Sidoarjo","Surabaya")
petaJawaTimur.printPeta()
print('------------------------------------------------')
petaJawaTimur.hapusKota("Sidoarjo")
petaJawaTimur.printPeta()
